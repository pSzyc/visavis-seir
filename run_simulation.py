...
result = run_simulation(
    ...
    logging_interval=5, # interval between timepoints (in minutes). Only integer values allowed.
    pulse_intervals=[180] * 6 + [120] * 6 + [60] * 6 +  [900], # list of intervals between pulses (in minutes). Must be int, only multiplicities of "logging_interval" allowed.
